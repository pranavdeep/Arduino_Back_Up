...
long total=0;
int check1=0,prev_level_total=0;
...
void loop() 
{
  ...
  else if ( (total>=3) && (total<7) && (flag==true) )
  {
    //check1=0;
    Serial.println("Level 1 completed, Entering Level-2, You get 4 leds");
    next_level(2,4,5000,false);
  }
  else if ( (total>=7) && (total<11) && (flag==true) )
  {
    //check1=0;
    Serial.println("Level 2 completed, Entering Level-3, You get 4 leds");
    next_level(3,4,4000,false);
  }
else if ( (total>=11) && (total<16 )&& (flag==true) )
  {
    //check1=0;
    Serial.println("Level 3 completed, Entering Level-4, You get 5 leds");
    next_level(4,5,4000,false);
  }
  else if ( (total>=16) && (total<21 )&& (flag==true) )
  {
    //check1=0;
    Serial.println("Level 4 completed, Entering Level-5, You get 5 leds");
    next_level(5,5,3500,false);
  }
  else if(total>=21)
  {
          ...
          if (currentMillis - previousMillis >= interval)
      {
          ...
          /*else
          {
            ...
            return total;
              ...
              if(total>=(prev_level_total+leds) )
              {
                //indicates that the level is completed
                flag=true;
                check1=0;
                prev_level_total=total;
                return total;
              }

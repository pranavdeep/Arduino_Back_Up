...
int flag2,flag1=0;//counter variable to check if a particular level is completed or not
long total=0;
int q,r,s,t=0;//variables to generate randomised cells
int check=0;//variable to control the entry of compiler into randomised number generator function only once for a particular level
